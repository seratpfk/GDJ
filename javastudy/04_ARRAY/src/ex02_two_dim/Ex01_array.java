...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		//       arr[0] = new int[5]; - 1번쨰 1차원 배열(첫 번째 김밥은 5개 조각)
		//       arr[1] = new int[3]; - 2번째 1차원 배열(두 번째 김밥은 3개 조각)
		//       arr[2] = new int[8]; - 3번째 1차원 배열(세 번째 김밥은 8개 조각)
		
		// 2차원 배열의 요소
		// 1. 인덱스를 2개를 사용
		//    몇 번쨰 1차원 배열인가? 해당 배열의 몇 번째 요소인가?
		// 2. 2차원 배열이 관리하는 1차원 배열
		//    arr[0]
		//    arr[1]
		//    arr[2]
		// 3. 각각의 1차원 배열이 관리하는 요소
		//    arr[0][0], arr[0][1]
		//    arr[1][0], arr[1][1]
		//    arr[2][0], arr[2][1]
