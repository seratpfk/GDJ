...
public class BoardTest {
	...
	public void 목록테스트() {  // 메소드명으로 한글을 많이 사용한다.
		...
		assertEquals(5, boards.size()); // 기대하는 숫자, 실제 목록의 갯수
		*/
	...
	public void 상세조회테스트() {
		...
		/*
		Board board = BoardDao.getInstance().selectBoardByNo(5);
		assertEquals("ㅇ", board.getTitle());
		*/
	...
	public void 게시글수정테스트() {
		...
		board.setBoardNo(1); // 게시글삽입테스트 결과로 삽입된 게시글번호
