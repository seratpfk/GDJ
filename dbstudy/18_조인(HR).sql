...
-- DEPARTMENTS 테이블 : LOCATION ID, DEPARTMENT_NAME
-- EMPLOYEES 테이블 : EMPLOYEE_ID, LAST_NAME
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME
  FROM DEPARTMENTS D INNER JOIN EMPLOYEES E -- PK, FK 순
    ON D.DEPARTMENT_ID = E.DEPARTMENT_ID -- 조인 조건
 WHERE D.LOCATION_ID = 1700;             -- 일반 조건
 
-- 조인을 쓰지 않는 문법
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME
  FROM DEPARTMENTS D, EMPLOYEES E        -- PK, FK 순서 바꿔도 출력됨.
...
--    단, DEPARTMENT_ID가 없는 사원은 조회하지 마시오. (* 커리문으로 구현을 하지 않아도 NULL 제외됨.)
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME, L.CITY, C.COUNTRY_NAME
  FROM COUNTRIES C INNER JOIN LOCATIONS L
    ON C.COUNTRIES_ID = L.COUNTRIES_ID INNER JOIN DEPARTMENTS D
...
SELECT E.EMPLOYEE_ID, E.LAST_NAME, D.DEPARTMENT_NAME, NVL(D.DEPARTMENT_NAME, 'None')
