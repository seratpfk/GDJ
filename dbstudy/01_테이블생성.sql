...
-- 1. 제약조건이름 없이 테이블 만들기
DROP TABLE USER_TBL; --USER_TBL지운 다음에 다시 만들기 
CREATE TABLE USER_TBL(
    USER_ID VARCHAR2(30 BYTE) NOT NULL PRIMARY KEY, --기본키
    USER_PW VARCHAR2(30 BYTE) NOT NULL, -- 필수사항
    USER_NAME VARCHAR2(30 BYTE) NULL, -- 선택 안 할 수 있음
    USER_AGE NUMBER(3) NULL CHECK(USER_AGE BETWEEN 1 AND 100),
...
DROP TABLE USER_TBL; --USER_TBL지운 다음에 다시 만들기 
CREATE TABLE USER_TBL(
    USER_ID VARCHAR2(30 BYTE) NOT NULL, --기본키
    USER_PW VARCHAR2(30 BYTE) NOT NULL, -- 필수사항
    USER_NAME VARCHAR2(30 BYTE) NULL, -- 선택 안 할 수 있음
...
CREATE TABLE USER_TBL(
    ...
    USER_AGE NUMBER(3) NULL CONSTRAINT CK_USER_AGE CHECK(USER_AGE BETWEEN 1 AND 100),
    USER_ADDR VARCHAR2(30 BYTE) NULL,
