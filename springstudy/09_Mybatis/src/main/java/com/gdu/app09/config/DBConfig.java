...
/*
    ...
    안뇽?난 프로퍼티 파일을 참조할 수 있는 애너테이션이야
 */

@PropertySource(value = {"classpath:mybatis/config/db.properties"}) // resources 파일에 깔아둔 마이바티스 파일 경로  // DB 파일 경로 지정
